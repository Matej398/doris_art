...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch wall paintings' }, { status: 500 });
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error adding wall painting image:', error);
    return NextResponse.json({ error: 'Failed to add wall painting image' }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Error updating wall paintings:', error);
    return NextResponse.json({ error: 'Failed to update wall paintings' }, { status: 500 });
  }
}
