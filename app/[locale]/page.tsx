    ...
    <Link href={category.href as any} className="group flex flex-col items-start flex-shrink-0">
      ...
      >
        <Image
          ...
          width={288}
          height={288}
          sizes="(max-width: 768px) 224px, (max-width: 1024px) 240px, 288px"
      ...
      <footer className="px-6 md:px-10 py-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/doriseinfalt_art/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-stone-900 hover:text-accent transition-colors">
            ...
            <a href="https://www.facebook.com/doris.einfalt.3/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-stone-900 hover:text-accent transition-colors">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
