      ...
      <footer className="px-6 md:px-10 py-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/doriseinfalt_art/" target="_blank" rel="noopener" className="text-stone-900 hover:text-accent transition-colors">
            ...
            <a href="https://www.facebook.com/doris.einfalt.3/" target="_blank" rel="noopener" className="text-stone-900 hover:text-accent transition-colors">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
